...
public class farmaciaController {
	...
	@RequestMapping(value="operacion/{operacion}/operador1/{operador1}/operador2/{operador2}",method=RequestMethod.GET)
		//public ModelAndView irA (@PathVariable String operacion,@PathVariable Integer operador1,
	//@PathVariable Integer operador2){
				public ModelAndView irACalcular (@PathVariable String operacion,@PathVariable Integer operador1,
						@PathVariable Integer operador2) {
